...
public final class HudOverlay {
    ...
    private static void renderCompass(GuiGraphics graphics, int x, int y) {
        ...
        for (int angle = 0; angle < 360; angle += 15) {
            ...
            if (major) graphics.drawCenteredString(minecraft.font, cardinal(angle), tickX, y + 20, TEXT);
            else graphics.drawCenteredString(minecraft.font, Integer.toString(angle), tickX, y + 21, 0xFF7F8B95);
        }
